...
namespace {
    ...
    void test_tool_protocol_round_trips() {
        ...
        require(parsed_list->tools.front().title == "Echo Tool", "tool title mismatch");
        ...
        require(parsed_list->tools.front().output_schema.at("type") == "object", "tool output schema mismatch");
        require(parsed_list->tools.front().annotations.at("beta"), "tool annotations mismatch");
        require(parsed_list->tools.front().meta.has_value(), "tool meta mismatch");
        require(parsed_list->tools.front().meta->at("source") == "unit-test", "tool meta value mismatch");
    ...
    void test_task_protocol_round_trips() {
        ...
        const auto task_result_json = mcp::protocol::task_result_params_to_json(task_result_parameters);
        const auto parsed_task_result = mcp::protocol::task_result_params_from_json(task_result_json);
        require(parsed_task_result.has_value(), "task result parameters should parse");
        require(parsed_task_result->task_id == "task-1", "task result task id mismatch");
        ...
        require(capabilities_json.at("experimental").at("beta"), "client capabilities experimental mismatch");
        ...
        require(parsed_capabilities->experimental.has_value(), "parsed client capabilities experimental missing");
        require(parsed_capabilities->experimental->at("beta"), "parsed client capabilities experimental mismatch");
    ...
    void test_prompt_protocol_round_trips() {
        ...
        require(parsed_list->prompts.front().title == "Summarize Prompt", "prompt title mismatch");
        ...
        require(parsed_list->prompts.front().arguments.front().title == "Text Argument",
        ...
        require(parsed_list->prompts.front().arguments.front().meta.has_value(), "prompt argument meta missing");
        require(parsed_list->prompts.front().annotations.at("beta"), "prompt annotations mismatch");
    ...
    void test_resource_protocol_round_trips() {
        ...
        require(parsed_list->resources.front().title == "Readme", "resource title mismatch");
        ...
        require(parsed_list->resources.front().annotations.at("beta"), "resource annotations mismatch");
        require(parsed_list->resources.front().meta.has_value(), "resource meta missing");
