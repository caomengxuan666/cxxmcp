...
namespace mcp::app {
    ...
    using GatewayPromptGetter = std::function<core::Result<protocol::PromptsGetResult>(
            std::string_view server_id,
            const protocol::PromptsGetParams &params)>;
    using GatewayResourceReader = std::function<core::Result<protocol::ResourcesReadResult>(
            std::string_view server_id,
    ...
    using GatewayServerHealthProvider = std::function<std::vector<GatewayServerHealth>()>;
    ...
    public:
        ...
        core::Result<std::vector<protocol::ToolDefinition>> list_tools(std::string_view profile_id) const;
        core::Result<std::vector<protocol::Prompt>> list_prompts(std::string_view profile_id) const;
        core::Result<std::vector<protocol::Resource>> list_resources(std::string_view profile_id) const;
        core::Result<protocol::PromptsGetResult> get_prompt(std::string_view profile_id,
                                                            std::string_view exposed_name,
                                                            protocol::Json arguments) const;
        core::Result<protocol::ResourcesReadResult> read_resource(std::string_view profile_id,
    ...
    public:
        GatewayRequestHandler(const GatewayRoutingService &routing, std::string profile_id);

        core::Result<protocol::JsonRpcResponse> handle(const protocol::JsonRpcRequest &request) const;
