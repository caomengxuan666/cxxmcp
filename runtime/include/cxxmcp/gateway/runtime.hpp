...
namespace mcp::gateway {
    ...
    public:
        ...
        public:
            ...
            Builder &add_stdio_server(std::string id,
                                      std::string command,
                                      std::vector<std::string> args = {});
            Builder &add_http_server(std::string id, std::string url);
            Builder &add_env(std::string server_id, std::string name, std::string value);
            Builder &add_header(std::string server_id, std::string name, std::string value);
