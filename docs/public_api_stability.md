...
Gateway/runtime/CLI/plugin tooling lives outside this SDK repository. Tooling,
...
review, release notes, and package evidence. External gateway/tooling
repositories must define their own compatibility promise instead of relying on
...
- optional package-surface evidence for advertised auth/OpenSSL targets;
