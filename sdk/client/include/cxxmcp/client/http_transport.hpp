...
/// @file
/// @brief HTTP client transport for MCP streamable HTTP and SSE-compatible endpoints.
...
namespace mcp::client {
    ...
    /// Client(std::unique_ptr<Transport>) or indirectly through Client factory helpers.
