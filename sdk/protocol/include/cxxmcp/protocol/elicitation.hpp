...
namespace mcp::protocol {
    ...
    /// @brief Builds an InvalidRequest error for elicitation JSON validation failures.
    ...
    /// @note URL mode omits `requestedSchema`; form mode omits `elicitationId` and `url`.
