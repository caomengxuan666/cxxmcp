...
namespace mcp::protocol {
    ...
    inline core::Result<Resource> resource_from_json(const Json &json) {
        ...
        if (json.contains("title")) {
            if (!json.at("title").is_string()) {
                return std::unexpected(resource_json_error("resource title must be a string"));
            }
        }
        ...
        if (json.contains("size")) {
            if (!json.at("size").is_number_integer()) {
                return std::unexpected(resource_json_error("resource size must be an integer"));
            }
    ...
    inline core::Result<ResourceTemplate> resource_template_from_json(const Json &json) {
        ...
        if (json.contains("title")) {
            if (!json.at("title").is_string()) {
                return std::unexpected(resource_json_error("resource template title must be a string"));
            }
        }
        ...
        if (json.contains("size")) {
            if (!json.at("size").is_number_integer()) {
                return std::unexpected(resource_json_error("resource template size must be an integer"));
            }
