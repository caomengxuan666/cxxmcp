...
/// @file cxxmcp/protocol.hpp
/// @brief SDK umbrella header for Model Context Protocol JSON-RPC model types.
/// @note Concrete DTOs and serialization helpers are documented in the
///       component headers under `cxxmcp/protocol/`.
